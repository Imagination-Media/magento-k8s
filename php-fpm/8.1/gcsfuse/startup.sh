...
/usr/bin/gsutil --implicit-dirs --dir-mode "775" --uid "$(id -u nginx)" --gid "$(id -g nginx)" -o allow_other -m rsync -rj "$gke_bucket_var_log" /var/www/html/var/log
...
/usr/bin/gsutil --implicit-dirs --dir-mode "775" --uid "$(id -u nginx)" --gid "$(id -g nginx)" -o allow_other -m rsync -rj "$gke_bucket_pub_media" /var/www/html/pub/media
